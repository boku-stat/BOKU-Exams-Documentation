---
title: "Automated generation of tests/exams with R/exams"
format: 
    revealjs: 
      echo: true
      theme: default
...
At the *Institute of Statistics* we teach Statistics with **R**

- **Continuous practice** of the methods learned is essential

- Manual correction unfeasible for **hundreds of students**

- **Feedback** for the students during practice is crucial

- Limited options in BOKUlearn


<div style="display: flex; justify-content: space-around;">
  <img src="images/devices.png" width="30%">
  <img src="images/exam.jpg" width="30%">
  <img src="images/exercise.jpg" width="30%">
</div>
...
- Full calculation is available such that **intermediate results** can also be evaluated

- Use randomization to generate **individual assignments** 

- Possibility of allowing **multiple trials** with feedback

- Use same system to generate written exams
...
- Tests in BOKUlearn can be automatically evaluated 
- Feedback can be provided using the .Rmd file 

![](images/feedback_num.png)

## How are these exercises created? 

- Use a package for R called `R/exams`
- Developed for automatic and individualized creation of exams 
- Lots of documentation

## Official `R/exams` webpage

![](images/rexams_web.png)

## Documentation written by us 

![](images/docu_web.png)

## Advantages of `R/exams`

- A large number of different exercises can be created from just one file 
- Numbers, context, etc. vary for each student 
- Question pool 
- Automatic evaluation in combination with BOKUlearn 

## Basic concept 

![](images/oneforall.svg){fig-align="center" width=50%} 
...
1. Data Generation
  - Data examples: csv file, sample data from distribution

2. Collect all relevant solutions
  - For example: computed based on the data, fixed solution
...
exams2moodle(file = "name_of_file.Rmd", n = 200) #ouput: xml 
```

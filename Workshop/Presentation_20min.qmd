...
- A large number of slightly different exercises can be created from just one file 
...
# Personal Use Case: Coaches 

- Coaches are used as extra practice 
- 200 versions of each exercise 
  - different numbers 
  - different "story" 
- 10 tries, students know which sub-questions are correct/false 

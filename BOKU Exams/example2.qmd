...
This is an exercise containing two text questions.

The whole example can be downloaded here:

{{< downloadthis example_string.Rmd dname="string_example" >}}
...
```{.markdown include="example_string.Rmd" start-line=22 end-line=35}
```


## Solution Section 

In this section, additional information and/or the exact solutions can be given. In this case, the information which is stored in the `explanations` list is pasted here through this code chunk. 

```{.markdown include="example_string.Rmd" start-line=36 end-line=41}
```

## Meta Information Section 

```{.markdown include="example_string.Rmd" start-line=42 end-line=51}
```
